...
JS_SOURCES=(wm.js apps/registry.js apps/resume.js apps/projects.js apps/skills.js apps/about.js apps/contact.js apps/terminal.js apps/research.js apps/services.js main.js)
